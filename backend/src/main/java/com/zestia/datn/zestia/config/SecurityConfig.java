    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/payment/vnpay/return", "/api/payment/momo/return", "/api/payment/zalopay/return", "/api/payment/order/**").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/payment/momo/ipn", "/api/payment/zalopay/callback").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/hoa-don/search", "/api/hoa-don/search-by-phone", "/api/hoa-don/*/tracking").permitAll()
