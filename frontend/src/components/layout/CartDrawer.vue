    ...
    <div class="lm-cart-drawer" role="dialog" aria-modal="true" aria-labelledby="cart-drawer-title" @click.stop>
      ...
      <div class="flex-grow-1 overflow-auto px-4 py-3">
        ...
        <div v-for="item in cart.state.items" :key="item.id"
             ...
             style="grid-template-columns:80px 1fr;gap:16px;border-bottom:1px solid var(--lm-beige)">
          <!-- Thumb -->
          ...
          <div class="d-flex flex-column">
            ...
            <div style="font-size:10px;color:var(--lm-gray);letter-spacing:0;text-transform:uppercase;margin-bottom:12px;flex:1">{{ item.variant }}</div>
      ...
      <div class="px-4 py-3" style="border-top:1px solid var(--lm-beige)">
        <div class="d-flex justify-content-between align-items-center mb-1">
          <span style="font-size:10px;font-weight:500;letter-spacing:0;text-transform:uppercase;color:var(--lm-gray)">Tạm tính</span>
