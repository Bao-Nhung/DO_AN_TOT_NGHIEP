...
#lm-toast.lm-toast-success .lm-toast-icon {
  color: #10b981;
}
...
#lm-toast.lm-toast-error {
  ...
  background: linear-gradient(135deg, #fef2f2 0%, #fdf7f7 100%);
}

#lm-toast.lm-toast-error .lm-toast-icon {
  color: #ef4444;
}
...
#lm-toast.lm-toast-info .lm-toast-icon {
  color: #3b82f6;
}

/* Warning */
#lm-toast.lm-toast-warning {
  border-left-color: #f59e0b;
  background: linear-gradient(135deg, #fffbeb 0%, #fdf9f3 100%);
}

#lm-toast.lm-toast-warning .lm-toast-icon {
  color: #f59e0b;
}
