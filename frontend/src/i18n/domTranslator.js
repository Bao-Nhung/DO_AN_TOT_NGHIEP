...
const phraseOverrides = {
  ...
  'Mua trực tiếp tại cửa hàng': 'In-store purchase',
  'Nhân viên': 'Employee',
  'Khách hàng': 'Customer',
  'Sản phẩm': 'Product',
  'Đơn hàng': 'Order',
  ...
  'Váy cách tân': 'Modernized dresses',
  'Váy dạ hội': 'Evening gowns',
  'Váy cưới': 'Bridal dresses',
  'Váy học sinh': 'School dresses',
  'Váy công sở': 'Tailored office dresses',
  'Váy dự tiệc': 'Party & cocktail dresses',
  'Áo thời trang': 'Fashion tops & blouses',
  'Quần & Jeans': 'Pants & Denim',
  'Váy & Đầm': 'Dresses & Skirts',
  'Phụ kiện thời trang': 'Fashion accessories',
  'Trang phục công sở': 'Workwear & tailoring',
  'Trang phục dự tiệc': 'Eveningwear & cocktail dress',
  'Áo khoác & Blazer': 'Jackets & Blazers',
  ...
  'Tư vấn chọn size': 'Size guidance',
  'Ưu đãi': 'Special offer',
  'Chọn váy theo khoảnh khắc': 'Find dresses for every occasion',
  'Được chọn nhiều nhất': 'Most-loved styles',
  'Hàng mới tháng này': 'New arrivals this month',
  'Trải nghiệm đã xác minh': 'Verified customer reviews',
  ...
  'Tiêu chí': 'Criteria',
  'Vui lòng chọn Màu sắc trước khi mua!': 'Please select a color option before adding to cart!',
  'Vui lòng chọn Kích thước trước khi mua!': 'Please select a size option before adding to cart!',
  'Vui lòng chọn màu và kích cỡ muốn đổi': 'Please select the desired color and size for exchange',
  'Vui lòng mô tả tình trạng hàng ít nhất 10 ký tự': 'Please describe item condition with at least 10 characters',
  'Vui lòng nhập đầy đủ thông tin nhận tiền hoàn': 'Please enter complete bank refund details',
  'Vui lòng tải ít nhất một ảnh tình trạng hàng': 'Please upload at least one photo of the item condition',
  'Mỗi ảnh chỉ được tối đa 5MB': 'Each photo must not exceed 5 MB',
  'Vui lòng chọn lý do hủy!': 'Please select a cancellation reason!',
  'Vui lòng nhập lý do cụ thể!': 'Please enter a specific reason!',
  'Vui lòng chọn sản phẩm': 'Please select an item',
  'Số lượng không hợp lệ': 'Invalid quantity requested',
  'Vui lòng nhập mã đơn hàng': 'Please enter your order code',
  'Vui lòng nhập số điện thoại': 'Please enter your phone number',
  'Vui lòng nhập mã OTP gồm 6 chữ số': 'Please enter the 6-digit OTP code',
